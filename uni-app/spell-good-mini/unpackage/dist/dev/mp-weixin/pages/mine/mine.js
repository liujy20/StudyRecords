...
var _mine = _interopRequireDefault(__webpack_require__(/*! ./pages/mine/mine.vue */ 81));
// @ts-ignore
...
try {
  components = {
    qiunDataCharts: function () {
      return Promise.all(/*! import() | uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts")]).then(__webpack_require__.bind(null, /*! @/uni_modules/qiun-data-charts/components/qiun-data-charts/qiun-data-charts.vue */ 144))
    },
  }
} catch (e) {
  if (
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _this.$http.httpUser.getUserInfo();
            case 4:
            ...
            case 6:
              _this.getServerData1();
              _this.getServerData2();
            case 8:
            case "end":
  ...
  methods: _objectSpread(_objectSpread({}, mapMutations(['setUserInfo'])), {}, {
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        _this2.userInfo.avatarUrl = uploadRes.data;
                        _context2.next = 5;
                        return _this2.$http.httpUser.setUserInfo(_this2.userInfo);
                      case 5:
                        setRes = _context2.sent;
                        console.log(setRes);
                      case 7:
                      case "end":
    ...
    getServerData1: function getServerData1() {
      ...
      setTimeout(function () {
        ...
        _this4.chartData1 = JSON.parse(JSON.stringify(res));
      }, 500);
    },
    getServerData2: function getServerData2() {
      var _this5 = this;
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        var orderListRes, data, res;
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _this5.$http.httpOrder.getOrderList({});
              case 2:
                orderListRes = _context4.sent;
                console.log(orderListRes.data);
                data = orderListRes.data.reduce(function (arr, order) {
                  var currentOrder = arr.find(function (item) {
                    return item.order_type == order.order_type;
                  });
                  if (!currentOrder) {
                    arr.push({
                ...
                _this5.chartData2 = JSON.parse(JSON.stringify(res));
              case 8:
              case "end":
