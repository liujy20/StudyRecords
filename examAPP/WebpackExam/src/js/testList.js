import '@scss/testList.scss'
import '@scss/common.scss'
import '@js/resize.js'
import '@js/testList.js'
import {getPromise,getPromiseAuth} from '@util/util.js'
let studentId = localStorage.getItem("user");

import testImg from '../img/Tests/test-1.png'
import clockImg from '../img/Tests/clock.png'
...
function renderIngList() {
  let arr = ingData.map((item) => {
    return `<div class="item">
      <img src="${testImg}" alt="" class="left" />
      <div class="center">
        <div class="test-name">
